...
*Status: archived after clean review*
*Link: [./tracks/archive/40_repo_quality_ci_automation_20260701/](./tracks/archive/40_repo_quality_ci_automation_20260701/)*
...
*Status: archived after clean review*
*Link: [./tracks/archive/17_nlp_pipeline_publication_audit/](./tracks/archive/17_nlp_pipeline_publication_audit/)*

## Track 16: nztaxmicrosim Follow-on Reconciliation
*Status: archived after clean review*
*Link: [./tracks/archive/16_nztaxmicrosim_follow_on_reconciliation/](./tracks/archive/16_nztaxmicrosim_follow_on_reconciliation/)*

## Track 15: OpenFisca Follow-on Reconciliation
*Status: archived after clean review*
*Link: [./tracks/archive/15_openfisca_follow_on_reconciliation/](./tracks/archive/15_openfisca_follow_on_reconciliation/)*
...
*Status: archived after clean review*
*Link: [./tracks/archive/33_rates_rebates_and_local_government_assistance/](./tracks/archive/33_rates_rebates_and_local_government_assistance/)*

## Track 32: Paid parental leave, child support, and family-related payments
*Status: archived after clean review*
*Link: [./tracks/archive/32_paid_parental_leave_child_support_family_payments/](./tracks/archive/32_paid_parental_leave_child_support_family_payments/)*
...
*Status: archived after clean review*
*Link: [./tracks/archive/18_rulespec_rule_inventory_triangulation/](./tracks/archive/18_rulespec_rule_inventory_triangulation/)*

## Track 14: PolicyEngine NZ Rule Incorporation
*Status: archived after review remediation*
*Link: [./tracks/archive/14_policyengine_nz_rule_incorporation/](./tracks/archive/14_policyengine_nz_rule_incorporation/)*

## Track 13: OpenFisca Aotearoa Rule Incorporation
*Status: archived after review remediation*
*Link: [./tracks/archive/13_openfisca_aotearoa_rule_incorporation/](./tracks/archive/13_openfisca_aotearoa_rule_incorporation/)*

## Track 1: Rust Core & Apache Arrow Integration (`rulespec-nz`)
*Status: archived with host toolchain coverage blocker*
*Link: [./tracks/archive/01_rust_core_arrow/](./tracks/archive/01_rust_core_arrow/)*

## Track 2: OpenFisca Parsing & Transpilation Adapter
*Status: archived after review remediation*
*Link: [./tracks/archive/02_openfisca_migration/](./tracks/archive/02_openfisca_migration/)*

## Track 3: Legislation Ingestion - Income Tax Act rate schedules
*Status: archived after clean review*
*Link: [./tracks/archive/03_income_tax_rates/](./tracks/archive/03_income_tax_rates/)*

## Legacy Track: nz_ingest_tax_rate_20260619
*Status: archived superseded by Track 3*
*Link: [./tracks/archive/nz_ingest_tax_rate_20260619/](./tracks/archive/nz_ingest_tax_rate_20260619/)*

## Track 4: Legislation Ingestion - Social Security Act welfare benefit schedules
*Status: archived after clean review*
*Link: [./tracks/archive/04_social_security_benefits/](./tracks/archive/04_social_security_benefits/)*

## Track 5: Legislation Ingestion - GST Act and ACC levies
*Status: archived after clean review*
*Link: [./tracks/archive/05_gst_acc_levies/](./tracks/archive/05_gst_acc_levies/)*

## Track 6: Legislation Ingestion - New Zealand Superannuation Act
*Status: archived after review remediation*
*Link: [./tracks/archive/06_nz_superannuation/](./tracks/archive/06_nz_superannuation/)*

## Track 7: Ingestion Adapter for Local Parquet Layers (`corpus-legislation-nz` & `corpus-nz-hansard`)
*Status: archived after review remediation*
*Link: [./tracks/archive/07_corpus_parquet_ingest/](./tracks/archive/07_corpus_parquet_ingest/)*

## Track 8: Microsimulation Synthetic Population Builder (`open_social_data` & `fyi-cli`)
*Status: archived after review remediation*
*Link: [./tracks/archive/08_microsimulation_populations/](./tracks/archive/08_microsimulation_populations/)*

## Track 9: Regression and Value of Information Outputs Pipeline (`mars` & `voiage`)
*Status: archived after review remediation*
*Link: [./tracks/archive/09_regression_voi_pipeline/](./tracks/archive/09_regression_voi_pipeline/)*

## Track 10: State Ledger and Temporal Policy Ledger Integrations (`kairos` & `TheAxiomFoundation`)
*Status: archived after review remediation*
*Link: [./tracks/archive/10_state_ledger_temporal/](./tracks/archive/10_state_ledger_temporal/)*

## Track 11: Upstream PR Workflow System
*Status: archived after review remediation*
*Link: [./tracks/archive/11_upstream_pr_workflows/](./tracks/archive/11_upstream_pr_workflows/)*

## Track 12: nztaxmicrosim Rule Incorporation
*Status: archived after review remediation*
*Link: [./tracks/archive/12_nztaxmicrosim_rule_incorporation/](./tracks/archive/12_nztaxmicrosim_rule_incorporation/)*
